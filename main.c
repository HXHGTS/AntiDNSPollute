...
int WeakDNSMode() {
	...
	if (DNSSet == 1) {
		...
		system("netsh interface ip set dns \"以太网 2\" static 1.2.4.8");
		system("netsh interface ip add dns \"以太网 2\" 210.2.4.8 index=2");
		system("netsh interface ip set dns \"以太网 3\" static 1.2.4.8");
