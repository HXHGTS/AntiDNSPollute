...
char Hosts[50], ADFilterRules[600],WhiteList[2200];
...
int Config_gen() {
	...
	scanf("%d", &ADSwitch);
		...
		if (ADSwitch == 1) {
			...
			//ADFilter = fopen("FilterList.txt", "w");
			//fprintf(ADFilter, "https://easylist-downloads.adblockplus.org/abp-filters-anti-cv.txt\n");
			//fprintf(ADFilter, "https://easylist-downloads.adblockplus.org/easyprivacy.txt\n");
			//fprintf(ADFilter, "https://easylist-downloads.adblockplus.org/fanboy-social.txt\n");
			//fprintf(ADFilter, "https://easylist-downloads.adblockplus.org/easylistchina+easylist.txt\n");
			//fclose(ADFilter);
			//system("aria2c -x16 -i FilterList.txt");
			//system("copy /y abp-filters-anti-cv.txt data\\filters\\1588581704.txt");
			//system("copy /y easyprivacy.txt data\\filters\\1588581706.txt");
			//system("copy /y fanboy-social.txt data\\filters\\1588581707.txt");
			//system("copy /y easylistchina+easylist.txt data\\filters\\1588581708.txt");
			//system("del FilterList.txt");
			//system("del abp-filters-anti-cv.txt");
			//system("del easyprivacy.txt");
			//system("del fanboy-social.txt");
			//system("del easylistchina+easylist.txt");
