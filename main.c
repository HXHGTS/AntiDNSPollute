...
int main() {
	...
	if (mode == 2) {
		...
		if (DNSSet == 1) {
			...
			system("netsh interface ipv6 set dns \"以太网\" static 2001:de4::102");
			system("netsh interface ipv6 set dns \"WLAN\" static 2001:de4::101");
			system("netsh interface ipv6 set dns \"WLAN\" static 2001:de4::102");
		}
		else {
			...
			system("netsh interface ipv6 set dns \"以太网\" static 240c::6644");
			system("netsh interface ipv6 set dns \"WLAN\" static 240c::6666");
			system("netsh interface ipv6 set dns \"WLAN\" static 240c::6644");
		}
