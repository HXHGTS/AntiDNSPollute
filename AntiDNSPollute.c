...
char ADFilterRules[536],domain[50],NSCommand[72],Adapter[60], WhiteList[2800],Command[120],adguard_current_version[15], adguard_source_version[15],anti_current_version[4]="5.1", anti_source_version[4];
char TopDNS[35] = "  - 119.29.29.29\n  - 119.28.28.28\n";//定义上游DNS服务器为腾讯DNS，与最终结果无关
char Rewrite[432]="  - domain: '*.workers.dev'\n    answer: speed.cloudflare.com\n  - domain: 'ipv6check-http.steamcontent.com'\n    answer: 2404:3fc0:2:100::99fe:5683\n  - domain: 'api.steampowered.com'\n    answer: 104.110.72.183\n  - domain: 'ipv6check-udp.steamcontent.com'\n    answer: 2404:3fc0:2:101::99fe:5693\n  - domain: '*.cloudflare.com'\n    answer: speed.cloudflare.com\n  - domain: '*.s3.amazonaws.com'\n    answer: 's3.amazonaws.com'\n";//定义部分泛域名解析至CDN，避免原ip访问困难
char Hosts[6]="- \"\"\n";
